        ...
        <section class="teachers">
            <article class="first">
                ...
                <div>
                    ...
                    <button class="add-button">اضافة معلم</button>
                </div>
            </article>
            <div class="filter">
            ...
            <div class="teachers-list">
                ...
                <div class="body">
                    @foreach ($teachers as $teacher)
                        <div data-teacher="{{ $teacher->id }}" class="absence_days">
                            @foreach ($teacher->absence as $absence)
                                <div data-absence="{{ $absence->date }}"></div>
                            @endforeach
                        </div>
                        <div class="row">
                            <div class="someone">
                                <h4 class="num" data-teacher="{{ $teacher->id }}">{{ $teacher->id }}</h4>
                                <h4 class='name'>{{ $teacher->name }}</h4>
                                <h4 class='subject'>{{ $teacher->subject }}</h4>
                                <h4 class="phone">{{ $teacher->phone }}</h4>
                                <i class="far fa-trash-alt delbutton"></i>
                                <h4><i class=""></i></h4>
                            </div>
                            <div class="info">
                                <form class="teacher_image" data-teacher="{{ $teacher->id }}" method="post" action="{{ route('teachers.update', ['id' => $teacher->id]) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="img">
                                    ...
                                    <div class="details" data-teacher="{{ $teacher->id }}">
                                        <div data-attribute="name">
                                            <b class="filter-1">
                                                <h3>الاسم: </h3><span data-class="name">{{ $teacher->name }}</span>
                                            </b>
                                        ...
                                        <div data-attribute="national_id">
                                            <b class="filter-2">
                                                <h3>الرقم القومي: </h3><span>{{ $teacher->national_id }}</span>
                                            </b>
                                            <input type='text' class="hidden-edit">
                                            <i class="fas fa-pen"></i>
                                            <i class="fas fa-check-circle"></i>
                                        ...
                                        <div data-attribute="phone">
                                            <b>
                                                <h3>الهاتف: </h3><span data-class="phone">{{ $teacher->phone }}</span>
                                            </b>
                                            <input type='text' class="hidden-edit">
                                            <i class="fas fa-pen"></i>
                                            <i class="fas fa-check-circle"></i>
                                        ...
                                        <div data-attribute="email">
                                            <b>
                                                <h3>البريد الالكتروني: </h3><span>{{ $teacher->email }}</span>
                                            </b>
                                            <input type='text' class="hidden-edit">
                                            <i class="fas fa-pen"></i>
                                            <i class="fas fa-check-circle"></i>
                                        ...
                                        <div data-attribute="birthdate">
                                            <b>
                                                <h3>تاريخ الميلاد: </h3><span>{{ $teacher->birthdate }}</span>
                                            </b>
                                            <input type='text' class="hidden-edit">
                                            <i class="fas fa-pen"></i>
                                            <i class="fas fa-check-circle"></i>
                                        ...
                                        <div>
                                            <b>
                                                <h3>العمر: </h3><span>{{ $teacher->age }}</span>
                                            </b>
                                        </div>
                                        <div data-attribute="social_status">
                                            <b>
                                                <h3>الحالة الاجتماعية: </h3><span>{{ $teacher->social_status }}</span>
                                            </b>
                                        ...
                                        <div data-attribute="qualification">
                                            <b>
                                                <h3>المؤهل: </h3><span>{{ $teacher->qualification }}</span>
                                            </b>
                                            <input type='text' class="hidden-edit">
                                            <i class="fas fa-pen"></i>
                                            <i class="fas fa-check-circle"></i>
                                        ...
                                        <div data-attribute="religion">
                                            <b>
                                                <h3>الديانة: </h3><span>{{ $teacher->religion }}</span>
                                            </b>
                                            <select class='hidden-edit'>
                                                <option>مسلم</option>
                                                <option>مسيحي</option>
                                        ...
                                        <div data-attribute="degree">
                                            <b class="filter-4">
                                                <h3>الدرجة الحالية: </h3><span>{{ $teacher->degree }}</span>
                                            </b>
                                            <input type='text' class="hidden-edit">
                                            <i class="fas fa-pen"></i>
                                            <i class="fas fa-check-circle"></i>
                                        </div>
                                        <div data-attribute="subject">
                                            <b class="filter-3">
                                                <h3>المادة: </h3><span data-class="subject">{{ $teacher->subject }}</h3>
                                            </b>
                                            <input type='text' class="hidden-edit">
                                            <i class="fas fa-pen"></i>
                                            <i class="fas fa-check-circle"></i>
                                        ...
                                        <div>
                                            <b>
                                                <h3>الشهر الحالي: </h3><span>{{ $teacher->month_attendence }}%</span>
                                            </b>
                                        </div>
                                        <div>
                                            <b>
                                                <h3>الكلي: </h3><span>{{ $teacher->total_attendence }}%</span>
                                            </b>

                                        </div>
                                        <div data-attribute="salary">
                                            <b>
                                                <h3>المرتب الاساسي: </h3><span class="salary-val">{{ $teacher->salary }}</span>
                                            </b>
                                            <input type='text' class="hidden-edit">
                                            <i class="fas fa-pen"></i>
                                            <i class="fas fa-check-circle"></i>
                                        ...
                                        <div>
                                            <b>
                                                <h3>العلاوة: </h3><span class="yearly-bonus-val">{{ $teacher->yearly_bonus }}</span>
                                            </b>
                                        </div>
                                        <div>
                                            <b>
                                                <h3>الماكافئات: </h3><span class="bonus-val">{{ $teacher->monthExtras() }}</span>
                                            </b>
                                        </div>
                                        <div>
                                            <b>
                                                <h3>الخصومات: </h3><span class="pay-cut-val">{{ $teacher->monthPenalties() }}</span>
                                            </b>
                                        </div>
                                        <div>
                                            <b>
