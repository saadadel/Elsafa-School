...
<div class="form-group{{ $errors->has('avatar') ? 'has-error' : ''}}">
    ...
    {!! Form::text('avatar', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
<div class="form-group{{ $errors->has('job') ? 'has-error' : ''}}">
    ...
    {!! Form::text('job', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
<div class="form-group{{ $errors->has('yearly_bonus') ? 'has-error' : ''}}">
    {!! Form::label('yearly_bonus', 'Yearly Bonus', ['class' => 'control-label']) !!}
    {!! Form::text('yearly_bonus', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
    {!! $errors->first('yearly_bonus', '<p class="help-block">:message</p>') !!}
</div>
