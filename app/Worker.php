...
class Worker extends Model
{
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['name', 'avatar', 'national_id', 'phone', 'email', 'birthdate', 'social_status', 'qualification', 'religion', 'job', 'salary', 'yearly_bonus', 'st_name', 'building_num', 'region', 'city', 'country'];
