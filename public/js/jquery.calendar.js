...
(function ($) {
	...
	function initCalendar(wrapper, options) {
		...
		buttonLeft.on('click', function () { currentCalendar = $(this).parents('.calendar'); selectMonth(false, options);$('.today').nextAll('td').addClass('next');
        $('.today').parent().nextAll().find('td').addClass('next');
         });
		buttonLeft.on('mouseover', function () { $(this).css('background', createAccent(color, -20)); });
		buttonLeft.on('mouseout', function () { $(this).css('background', color); });
		...
		buttonRight.on('click', function () { currentCalendar = $(this).parents('.calendar'); selectMonth(true, options);$('.today').nextAll('td').addClass('next');
        $('.today').parent().nextAll().find('td').addClass('next');
         });
		buttonRight.on('mouseover', function () { $(this).css('background', createAccent(color, -20)); });
		buttonRight.on('mouseout', function () { $(this).css('background', color); });
